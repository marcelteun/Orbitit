...
trisAlt.base_key = {trisAlt.refl_1: True, trisAlt.refl_2: True, trisAlt.crossed_2: True}
...
class Shape(heptagons.FldHeptagonShape):
    def __init__(this, *args, **kwargs):
        heptagonsShape = geom_3d.SymmetricShape(
            vs=[], fs=[], isometries=isomA5, name="FoldedHeptagonsA5", regen_edges=False
        )
        xtraTrisShape = geom_3d.SymmetricShapeSplitCols(
            vs=[], fs=[], isometries=isomA5, name="xtraTrisA5", regen_edges=False
        )
    ...
    def initArrs(this):
        ...
        crossed_2 = [[0, 12, 44], [12, 14, 44], [14, 11, 44], [11, 13, 44], [13, 0, 44]]
        this.o5triFs_alts = []
...
class CtrlWin(heptagons.FldHeptagonCtrlWin):
    ...
    def has_only_hepts(self):
        return (
            ...
            and not (
                self.tris_fill == trisAlt.refl_1
                or self.tris_fill == trisAlt.refl_2
                or self.tris_fill == trisAlt.crossed_2
            )
        )
