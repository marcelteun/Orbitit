...
class CompoundS4A4:
    ...
    def create_a4xi(self, js_fd=None):
        ...
        polyh = S4A4.A4xI_C3(
            ...
            4,
            cols=[
                S4A4.A4xI_C3.orbit_cols[0],
                S4A4.A4xI_C3.orbit_cols[1],
                S4A4.A4xI_C3.orbit_cols[1],
                S4A4.A4xI_C3.orbit_cols[0],
            ],
        )
    ...
    def create_s4(self, js_fd=None):
        ...
        polyh = S4A4.S4_C3(
            ...
            8,
            cols=[
                S4A4.S4_C3.orbit_cols[0],
                S4A4.S4_C3.orbit_cols[0],
                S4A4.S4_C3.orbit_cols[1],
                S4A4.S4_C3.orbit_cols[1],
                S4A4.S4_C3.orbit_cols[2],
                S4A4.S4_C3.orbit_cols[2],
                S4A4.S4_C3.orbit_cols[3],
                S4A4.S4_C3.orbit_cols[3],
            ],
        )
        polyh.rot_base(polyh.mu[3])
        ...
        polyh = S4A4.S4_C2(
            ...
            12,
            cols=[
                S4A4.S4_C2.orbit_cols[0],
                S4A4.S4_C2.orbit_cols[1],
                rgb.gray,
                rgb.gray,
                rgb.gray,
                S4A4.S4_C2.orbit_cols[1],
                S4A4.S4_C2.orbit_cols[3],
                S4A4.S4_C2.orbit_cols[2],
                S4A4.S4_C2.orbit_cols[3],
                S4A4.S4_C2.orbit_cols[0],
                rgb.gray,
                S4A4.S4_C2.orbit_cols[2],
    ...
    def create_s4xi(self, js_fd=None):
        ...
        polyh = S4A4.S4xI_C2(
            ...
            cols=[
                S4A4.A4xI_C3.orbit_cols[0],
                S4A4.A4xI_C3.orbit_cols[2],
                S4A4.A4xI_C3.orbit_cols[3],
                S4A4.A4xI_C3.orbit_cols[1],
                S4A4.A4xI_C3.orbit_cols[0],
                S4A4.A4xI_C3.orbit_cols[2],
                S4A4.A4xI_C3.orbit_cols[1],
    ...
    def create_a5(self, js_fd=None):
        ...
        polyh = S4A4.A5_C3(
            ...
            cols=[
                ...
                S4A4.A4xI_C3.orbit_cols[2],
                S4A4.A4xI_C3.orbit_cols[2],
                S4A4.A4xI_C3.orbit_cols[10],
                S4A4.A4xI_C3.orbit_cols[4],
                S4A4.A4xI_C3.orbit_cols[5],
                S4A4.A4xI_C3.orbit_cols[8],
                S4A4.A4xI_C3.orbit_cols[3],
                S4A4.A4xI_C3.orbit_cols[7],
                S4A4.A4xI_C3.orbit_cols[5],
                S4A4.A4xI_C3.orbit_cols[8],
                S4A4.A4xI_C3.orbit_cols[1],
                S4A4.A4xI_C3.orbit_cols[4],
                S4A4.A4xI_C3.orbit_cols[0],
                S4A4.A4xI_C3.orbit_cols[6],
                S4A4.A4xI_C3.orbit_cols[6],
                S4A4.A4xI_C3.orbit_cols[3],
                S4A4.A4xI_C3.orbit_cols[7],
                S4A4.A4xI_C3.orbit_cols[0],
    ...
    def create_a5xi(self, js_fd=None):
        ...
        polyh = S4A4.A5xI_C3(
            ...
            40,
            cols=[
                S4A4.A5xI_C3.orbit_cols[0],
                S4A4.A5xI_C3.orbit_cols[0],
                S4A4.A5xI_C3.orbit_cols[1],
                S4A4.A5xI_C3.orbit_cols[2],
                S4A4.A5xI_C3.orbit_cols[3],
                S4A4.A5xI_C3.orbit_cols[2],
                S4A4.A5xI_C3.orbit_cols[3],
                S4A4.A5xI_C3.orbit_cols[2],
                S4A4.A5xI_C3.orbit_cols[9],
                S4A4.A5xI_C3.orbit_cols[4],
                S4A4.A5xI_C3.orbit_cols[4],
                S4A4.A5xI_C3.orbit_cols[0],
                S4A4.A5xI_C3.orbit_cols[0],
                S4A4.A5xI_C3.orbit_cols[6],
                S4A4.A5xI_C3.orbit_cols[10],
                S4A4.A5xI_C3.orbit_cols[10],
                S4A4.A5xI_C3.orbit_cols[3],
                S4A4.A5xI_C3.orbit_cols[3],
                S4A4.A5xI_C3.orbit_cols[6],
                S4A4.A5xI_C3.orbit_cols[6],
                S4A4.A5xI_C3.orbit_cols[6],
                S4A4.A5xI_C3.orbit_cols[7],
                S4A4.A5xI_C3.orbit_cols[8],
                S4A4.A5xI_C3.orbit_cols[7],
                S4A4.A5xI_C3.orbit_cols[7],
                S4A4.A5xI_C3.orbit_cols[9],
                S4A4.A5xI_C3.orbit_cols[8],
    ...
    def create_d2ndn(self, js_fd=None, no_of=None):
        ...
        for i in no_of:
            ...
            cols_alt = {
                4: [
                    S4A4.D2nDn_C2.orbit_cols[0],
                    S4A4.D2nDn_C2.orbit_cols[3],
                    S4A4.D2nDn_C2.orbit_cols[2],
                    S4A4.D2nDn_C2.orbit_cols[1],
                    S4A4.D2nDn_C2.orbit_cols[3],
                    S4A4.D2nDn_C2.orbit_cols[2],
                    S4A4.D2nDn_C2.orbit_cols[0],
                    S4A4.D2nDn_C2.orbit_cols[1],
...
class CompoundS4xI:
    ...
    def create_s4xi(self, js_fd=None):
        ...
        polyh = S4xI.S4xI_C3xI(
            ...
            8,
            cols=[
                S4xI.S4xI_C3xI.orbit_cols[0],
                S4xI.S4xI_C3xI.orbit_cols[0],
                S4xI.S4xI_C3xI.orbit_cols[1],
                S4xI.S4xI_C3xI.orbit_cols[2],
                S4xI.S4xI_C3xI.orbit_cols[3],
                S4xI.S4xI_C3xI.orbit_cols[2],
                S4xI.S4xI_C3xI.orbit_cols[3],
                S4xI.S4xI_C3xI.orbit_cols[1],
            ],
