...
STELLATIONS = [
    ...
    {
        "id": "De2f1f2",
        "vs": [VS[i] for i in [15, 25, 10, 12, 9, 33, 5, 36, 21, 24, 31]],
        "Fs": [[0, 1, 2], [0, 3, 4, 5, 6, 7, 8], [4, 9, 10]],
        "final": 0,
        "stab": 1,
        "col_alt": 2,
    },
    ...
    {
        "id": "e2f1f2g1",
        "vs": [VS[i] for i in [1, 19, 26, 10, 11, 36, 18, 5]],
        "Fs": [[0, 1, 2], [2, 3, 4], [3, 5, 0], [5, 6, 7]],
        "final": 0,
        "stab": 1,
        "col_alt": 2,
    },
    {
        "id": "De2f1f2g1",
        "vs": [VS[i] for i in [11, 26, 10, 36, 15, 25, 12, 18, 5, 21]],
        "Fs": [[0, 1, 2], [2, 3, 4, 5], [4, 6, 7, 8, 3, 9]],
        "final": 0,
        "stab": 1,
        "col_alt": 2,
    },
    {
        "id": "Ef1f2g1",
        "vs": [VS[i] for i in [15, 10, 36, 18, 5, 8, 9]],
        "Fs": [[0, 1, 2], [2, 3, 4], [3, 5, 6]],
        "final": 0,
        "stab": 1,
        "col_alt": 2,
    ...
    {
        "id": "e2f1f2g2",
        "vs": [VS[i] for i in [1, 25, 32, 10, 15, 36, 5, 33, 21, 18, 9, 24, 0]],
        "Fs": [[0, 1, 2, 3, 4], [3, 5, 6], [6, 7, 8, 9, 10], [9, 11, 12]],
        "final": 0,
        "stab": 1,
        "col_alt": 2,
    },
    ...
    {
        "id": "Ef1f2g2",
        "vs": [VS[i] for i in [25, 32, 10, 36, 5, 33, 21, 24, 9]],
        "Fs": [[0, 1, 2], [2, 3, 4], [4, 5, 6, 7, 8]],
        "final": 0,
        "stab": 1,
        "col_alt": 2,
    },
