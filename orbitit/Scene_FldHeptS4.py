...
class Shape(heptagons.FldHeptagonShape):
    def __init__(this, *args, **kwargs):
        heptagonsShape = geom_3d.SymmetricShape(
            vs=[], fs=[], isometries=isomS4, name="FoldedHeptagonsS4", regen_edges=False
        )
        xtraTrisShape = geom_3d.SymmetricShapeSplitCols(
            vs=[], fs=[], isometries=isomS4, name="xtraTrisS4", regen_edges=False
        )
    ...
    def set_vertices(this):
        ...
        if this.add_extra_faces:
            ...
            this.trisO4Shape.base_shape.vertex_props = {"vs": vs}
            this.trisO4Shape.base_shape.es = es
            this.trisO4Shape.base_fs_props = {"fs": fs}
...
class CtrlWin(heptagons.FldHeptagonCtrlWin):
    ...
    def has_only_hepts(self):
        return (
            self.pre_pos_enum == ONLY_HEPTS
            and not (self.tris_fill is None)
            and not (
                self.tris_fill == trisAlt.refl_1 or self.tris_fill == trisAlt.refl_2
            )
        )

    def has_only_o3_triangles(self):
        return (
            self.pre_pos_enum == ONLY_XTRA_O3S
            and not (self.tris_fill is None)
            and not (
                self.tris_fill == trisAlt.refl_1 or self.tris_fill == trisAlt.refl_2
            )
    ...
    pre_defined_special_pos_refl = {
        ONLY_HEPTS: [
            ...
            },
            {
                ...
                "set": [2.3706859974, -0.0, 1.4330985471, 1.1300265566],
            },
            {
            ...
            {
                "file": "frh-roots-0_0_0_0-fld_triangle.0-refl_1.json",
                "set": [2.3706859974, 0.0, 0.1376977796, 2.0115660970],
            },
            {
                "file": "frh-roots-0_0_0_0-fld_triangle.0-refl_2.json",
                "set": [
        ...
        T24_S6: [
            ...
            },
            {
                ...
                "set": [2.37068599744, 0.0, 2.12592133774, -0.23291939219],
            },
            {
                "file": "frh-roots-0_0_0_1-fld_parallel.0-refl_1.json",
                "set": [2.37068599744, 0.0, 2.12592133774, -2.44812695649],
            },
            {
            ...
            },
            {
                ...
                "set": [2.37068599744, 0.0, 2.05615681203, -1.70740415397],
            },
            {
                "file": "frh-roots-0_0_0_1-fld_triangle.0-refl_1.json",
                "set": [2.37068599744, 0.0, 2.05615681203, 0.14783100544],
            },
        ],
        T24_S30: [
            {
                "file": "frh-roots-0_0_1_1-fld_triangle.0-refl_1.json",
                "set": [2.370685997440, 0.0, 2.056156812030, 1.434188499620],
            },
            {
        ...
        T56_S6: [
            ...
            },
            {
                ...
                "set": [3.370685997440, 0.0, 1.091435866210, 0.801566079340],
            },
            {
                "file": "frh-roots-0_1_0_1-fld_parallel.0-refl_1.json",
                "set": [3.370685997440, 0.0, 1.091435866210, -1.413641484960],
            },
            {
                "file": "frh-roots-0_1_0_1-fld_parallel.0-refl_1.json",
                "set": [3.370685997440, 0.0, 0.479360460590, -0.801566079340],
            },
            {
                "file": "frh-roots-0_1_0_1-fld_parallel.0-refl_1.json",
                "set": [3.370685997440, 0.0, 0.479360460590, 1.413641484960],
            },
            {
